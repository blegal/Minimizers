...
//} LZ4F_preferences_t;
file_bz2_writer::file_bz2_writer(const std::string& filen)
{
    //
...
//
//
file_bz2_writer::~file_bz2_writer()
{
    if( is_open() == true )
        close();
}
...
//
//
int file_bz2_writer::write(char* buffer, int eSize, int eCount)
{
    int bzerror;
