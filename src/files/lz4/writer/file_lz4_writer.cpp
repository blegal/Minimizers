...
//} LZ4F_preferences_t;
file_lz4_writer::file_lz4_writer(const std::string& filen)
{
    //
...
//
//
file_lz4_writer::~file_lz4_writer()
{
    if( is_open() == true )
        close();
}
...
//
//
int file_lz4_writer::write(char* buffer, int eSize, int eCount)
{
    ...
    return ret; // nombre d'éléments de taille eSize
}
//
//
//
