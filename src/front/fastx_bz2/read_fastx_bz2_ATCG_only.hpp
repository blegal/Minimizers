...
class read_fastx_bz2_ATCG_only : public file_reader_ATCG_only
{
    // Buffers
    char* raw_buffer;      // Raw data from BZ2
...
public:
    ...
    read_fastx_bz2_ATCG_only(const std::string& filename, const uint64_t buff_size);
    ~read_fastx_bz2_ATCG_only();
