...
//              o_file = i_file + ".ordered";
            ...
            case 'M':
                limit_in_ram = std::atoi( optarg );
                break;

            case 'G':
                limit_in_ram = 1024 * std::atoi( optarg );
                break;
    ...
    if ( (optind < argc) || (help_flag == true) )
    {
        ...
        putchar ('\n');
        printf ("Usage :\n");
        printf ("./min_sorter_v3 --file [filename] --output [filename] [options]");
        putchar ('\n');
        printf ("Options :\n");
        ...
        printf ("                                  XXXX\n");
        printf ("                                  XXXX\n");
        printf (" --MB             (-M) [int]    : the quotient size\n");
        printf (" --GB             (-M) [int]    : the quotient size\n");
        printf ("\n");
        printf ("Others :\n");
